...
export default function ProjectApiList() {
  ...
  let apiList = {
    ...
    api_itemCategoryAll: `${baseUrl}/api/pms/master/category`,
    ...
    api_getActiveSubCategory: `${baseUrl}/api/pms/master/sub-category/by-category/active`,
    ...
    api_forwardStockDeadReqToI: `${baseUrl}/api/pms/da/stock-request/to-ia-dead`,
    ...
    api_iaDeadStockUpdateReqById: `${baseUrl}/api/pms/ia/deadstockupdateby`,
