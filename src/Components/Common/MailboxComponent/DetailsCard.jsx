...
function DetailsCard(props) {
  ...
  return (
    <>
                ...
                <div className='text-gray-700'>
                  <div className='grid md:grid-cols-2 text-sm'>
                    ...
                    <div className='grid grid-cols-2'>
                      ...
                      <div className='px-4 py-2'>
                        {props.applicationData.saf_no}
                      </div>
                    </div>
                    <div className='grid grid-cols-2'>
                      <div className='px-4 py-2 font-semibold'>Owner Name</div>
                      <div className='px-4 py-2'>
                        {props.applicationData.owner_name}
                      </div>
                    </div>
                    <div className='grid grid-cols-2'>
                      <div className='px-4 py-2 font-semibold'>
                    ...
                    <div className='grid grid-cols-2'>
                      ...
                      <div className='px-2 py-2'>
                        <div
                          className={
                            " rounded-full shadow-lg px-4 py-2 text-center text-sm  " +
                            (props.applicationData.assessment_type ==
                            "New Assessment"
                            ...
                            "Reassessment"
                              ...
                              : "") +
                            (props.applicationData.assessment_type == "Mutation"
      ...
      >
        <div
          className='rounded-lg  shadow-xl pt-4 bg-gray-400 ml-40'
