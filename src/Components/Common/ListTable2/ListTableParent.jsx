...
const ListTableParent = (props) => {
  ...
  const exportBtnStyle = `bg-green-800 text-white px-2 rounded-md flex items-center gap-1 hover:bg-green-500`;
      ...
      <div className='space-y-8'>
        <div className='w-full flex justify-between'>
          <div className='w-full flex justify-between'>
            ...
            >
              <button class='text-red bg-green-500 hover:before:bg-redborder-red-500 relative overflow-hidden border px-2 py-1 text-white shadow-2xl transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-green-900 before:transition-all before:duration-500 hover:text-white hover:before:left-0 hover:before:w-full rounded-md'>
