...
function PilotWorkflowDocumentUpload(props) {
  ...
  return (
    <>
                            ...
                            <div className='flex items-center'>
                              <span
                                className={`font-medium ${
                                  owner?.ownerDetails?.reqDocCount ===
      ...
      >
        <div className='relative overflow-x-auto bg-white rounded-lg shadow-xl border-2 border-gray-50 animate__animated animate__zoomIn animate__faster'>
          <div
      ...
      <Modal
        ...
        contentLabel='Example Modal'
      >
        <div className=' rounded-lg shadow-xl border-2 border-gray-200 bg-white md:ml-32 p-4 animate__animated animate__zoomIn animate__faster w-full md:w-[60vw] h-[80vh]'>
          <div
