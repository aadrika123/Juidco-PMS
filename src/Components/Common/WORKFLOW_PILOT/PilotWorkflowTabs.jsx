...
export default function PilotWorkflowTabs(props) {
  ...
  const notify = (toastData, actionFlag) => {
    ...
    {
      actionFlag == "de-escalated" && toast.success(toastData);
    }
    {
  ...
  const fetchDetailsById = () => {
    ...
    axios[props?.api?.api_details?.method](
      props?.api?.api_details?.url,
      { applicationId: props?.id },
      header
    )
  ...
  const stepperSetting = (currentRoleId) => {
    ...
    const extractedRoleArray = props?.workflowInfo?.members.map(
      (data, index) => {
        return data?.role_id;
      }
    );
  ...
  const funId = (id) => {
    setindex(id);
    console.log(
      "🚀 ~ file: PropertyConcessionDetailsTabs.js:147 ~ funId ~ id",
      id
    );
  };
  ...
  return (
    <>
            ...
            {props?.workflowInfo?.members?.map((data, index) => (
              <div>
                <StatusTimeline
                  ...
                  verificationStatus={
                    index < stepperCurrentIndex ? true : false
                  }
                  last={
                    index == props?.workflowInfo?.members?.length - 1
                      ? true
                      : false
                  }
          ...
          {5 > 4 && (
            <div className='mt-10 '>
              <div className='flex space-x-4 uppercase text-gray-600 text-sm pl-4 border-b-2 border-blue-500 mb-6 w-full overflow-x-auto whitespace-nowrap'>
                <div
                  onClick={() => changeTabFun(0)}
                  className={`pb-3 flex-initial cursor-pointer ${
                    activeTab == 0
                ...
                >
                  <span
                    className={`${
                      activeTab == 0
                        ? "after:bg-blue-500 after:h-5 after:w-5 after:absolute after:rotate-45 after:right-[35%] after:bottom-[-50%]"
                        : ""
                    }`}
                  ></span>
                ...
                {props?.workflowInfo?.permissions?.can_upload_document ==
                  true &&
                  (props?.boxType == "inbox" || props?.boxType == "btcbox") && (
                    <div
                      onClick={() => changeTabFun(3)}
                      className={`pb-3 flex-initial cursor-pointer ${
                        activeTab == 3
                          ? "relative text-blue-500"
                          : "no-underline border-none"
                ...
                {(props?.workflowInfo?.permissions?.can_view_document == true ||
                  props?.boxType == "btcbox") && (
                  <div
                    onClick={() => changeTabFun(1)}
                    className={`pb-3 flex-initial cursor-pointer ${
                      activeTab == 1
                        ? "relative text-blue-500"
                        : "no-underline border-none"
                ...
                {props?.workflowInfo?.permissions?.can_verify_document ==
                  true &&
                  props?.boxType == "inbox" && (
                    <div
                      onClick={() => changeTabFun(4)}
                      className={`pb-3 flex-initial cursor-pointer ${
                        activeTab == 4
                          ? "relative text-blue-500"
                          : "no-underline border-none"
                ...
                {props?.workflowInfo?.permissions?.allow_free_communication ==
                  true && (
                  <div
                    onClick={() => changeTabFun(5)}
                    className={`pb-3 flex-initial cursor-pointer ${
                      activeTab == 5
                        ? "relative text-blue-500"
                        : "no-underline border-none"
                  ...
                  >
                    ...
                    ></span>
                    <span>Departmental Communication</span>
                  </div>
                )}

                {props?.customTabs != null && (
                  <div
                    onClick={() => changeTabFun(6)}
                    className={`pb-3 flex-initial cursor-pointer ${
                      activeTab == 6
                        ? "relative text-blue-500"
                        : "no-underline border-none"
              ...
              <Box sx={{ width: "100%" }}>
                ...
                {activeTab == 1 &&
                  (props?.workflowInfo?.permissions?.can_view_document ==
                    true ||
                    props?.boxType == "btcbox") && (
                    <CustomErrorBoundary errorMsg='Bug in PilotWorkflowDocumentViewTab'>
                      <PilotWorkflowDocumentViewTab
                        applicationData={applicationData}
                        api={props?.api}
                        id={applicationId}
                      />
                ...
                {activeTab == 2 &&
                  (props?.boxType == "inbox" || props?.boxType == "btcbox") && (
                    <CustomErrorBoundary errorMsg='Bug in PilotWorkflowActions'>
                      <PilotWorkflowActions
                        allDocumentUploadStatus={allDocumentUploadStatus}
                        allDocumentVerifyStatus={allDocumentVerifyStatus}
                ...
                {activeTab == 3 &&
                  ...
                  (props?.boxType == "inbox" || props?.boxType == "btcbox") && (
                    <CustomErrorBoundary errorMsg='Bug in PilotWorkflowDocumentUpload'>
                      <PilotWorkflowDocumentUpload
                        canUpload={props?.canUpload}
                        allDocumentUploadStatus={allDocumentUploadStatus}
                        setallDocumentUploadStatus={setallDocumentUploadStatus}
                        allDocumentVerifyStatus={allDocumentVerifyStatus}
                        handleChangeTabs={handleChangeTabs}
                        api={props?.api}
                        id={applicationId}
                        applicationData={applicationData}
                        applicationData2={applicationData2}
                        refresh={() => setrefresh(refresh + 1)}
                        activateBottomErrorCard={activateBottomErrorCard}
                        isBtc={props?.boxType == "btcbox" ? true : false}
                      />
                    </CustomErrorBoundary>
                  )}
                {activeTab == 4 &&
                  ...
                  props?.boxType == "inbox" && (
                    <CustomErrorBoundary errorMsg='Bug in PilotWorkflowDocumentVerify'>
                      <PilotWorkflowDocumentVerify
                        allDocumentUploadStatus={allDocumentUploadStatus}
                        allDocumentVerifyStatus={allDocumentVerifyStatus}
                        setallDocumentVerifyStatus={setallDocumentVerifyStatus}
                        handleChangeTabs={handleChangeTabs}
                        api={props?.api}
                        id={applicationId}
                        activateBottomErrorCard={activateBottomErrorCard}
                ...
                {activeTab == 5 &&
                  props?.workflowInfo?.permissions?.allow_free_communication ==
                    ...
                    <CustomErrorBoundary errorMsg='Bug in PilotWorkflowDepartmentalCommunication'>
                      <PilotWorkflowDepartmentalCommunication
                        workflow={props?.workflow}
                        permissions={props?.workflowInfo?.permissions}
                        applicationData={applicationData}
                        departmentalPost={
                          applicationData?.data?.departmentalPost
                        }
                        api={props?.api}
                        id={applicationId}
                        roleId={roleId}
      ...
      >
        <div
          style={{ zIndex: 10000 }}
          className='relative bg-white rounded-lg shadow-xl border-2 border-gray-50'
        >
          <button
            onClick={closeModal}
            type='button'
          ...
          <div className='p-6 text-center'>
            ...
            <button
              type='button'
              className='text-white bg-green-400  hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-sky-300 dark:focus:ring-sky-800 font-medium rounded-lg text-sm inline-flex items-center px-8 py-2.5 text-center mr-2'
              onClick={closeModal}
            >
              Back
            </button>
