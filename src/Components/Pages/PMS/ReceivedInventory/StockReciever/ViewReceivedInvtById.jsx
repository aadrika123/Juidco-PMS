...
const ViewReceivedInvtById = () => {
  ...
  const addProduct = () => {
    ...
    AxiosInterceptors.post(
      ...
      .catch(function (error) {
        console.log("==2 details by id error...", error);
        toast.error(error?.response?.data?.message || "Error in adding details");
        seterroState(true);
        setisLoading(false);
      })
                    ...
                    <div className="col-span-12  w-full mb-20">
                      ...
                      {product.map((item, index) => (
                        ...
                        >
                          ...
                          <div className=" form-group flex-shrink max-w-full px-4 w-full md:w-[20%]">
                            {/* <div class="px-4 w-full"> */}
                            {product.length - 1 === index && (
                              <button
                                className={`${buttonStyle2} mt-8`}
                                onClick={addField}
                              >
                                Add
                              </button>
