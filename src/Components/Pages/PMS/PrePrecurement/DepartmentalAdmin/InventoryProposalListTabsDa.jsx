...
const InventoryProposalListTabs = () => {
  ...
  const {
    ...
    api_fetchProcurementDAListInbox,
  ...
  return (
    <>
       <div className="">
    <TitleBar titleBarVisibility={titleBarVisibility} titleText={"Inventory Proposal"} />
    </div>
    ...
    <div className='flex ml-5'>
      ...
      <div className="mt-4">
        {activeTab === 'inbox' && <div><InventoryProposalList page='inbox' api={api_fetchProcurementDAListInbox} /></div>}
        {activeTab === 'outbox' && <div><InventoryProposalList page='outbox' api={api_fetchProcurementDAListOutbox} /></div>}
      </div>
    </div>
