...
const InventoryProposalListTabs = () => {
  ...
  return (
    ...
    <div>
        <h1 className='text-[35px] text-right pb-5 font-bold'>Inventvory Proposal</h1>
    </div>
      <div>
              <button 
      ...
      <div className="flex border-b border-gray-200">
        <button
          className={`py-2 px-4 ${activeTab === 'inbox' ? 'border-b-2 border-blue-500 text-white bg-[#4338CA]' : 'text-gray-500'} focus:outline-none flex border border-[#4338ca]`}
        ...
        <button
          className={`ml-4 py-2 px-4 ${activeTab === 'outbox' ? 'border-b-2 border-blue-500 text-white bg-[#4338CA]' : 'text-gray-500'} focus:outline-none flex border border-[#4338ca]`}
