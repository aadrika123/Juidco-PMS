...
const BoqListTabsFin = () => {
  const [activeTab, setActiveTab] = useState("inbox");
  const { api_fetchFinanceBoqListInbox, api_fetchFinanceBoqListOutbox } =
    ProjectApiList();
          ...
          {activeTab === "inbox" && (
            <div>
              <InventoryProposalList
                page='inbox'
                api={api_fetchFinanceBoqListInbox}
              />
            </div>
          )}
          {activeTab === "outbox" && (
            <div>
              <InventoryProposalList
                page='outbox'
                api={api_fetchFinanceBoqListOutbox}
              />
            </div>
          )}
        </div>
