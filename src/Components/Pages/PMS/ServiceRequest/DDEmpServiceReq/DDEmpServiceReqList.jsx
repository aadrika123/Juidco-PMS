...
//    Revision - 1
//    Project - JUIDCO
//    Component  - DDEmpServiceReqList
//    DESCRIPTION - DDEmpServiceReqList
//////////////////////////////////////////////////////////////////////////////////////
...
function DDEmpServiceReqList(props) {
      ...
      Cell: ({ cell }) => (
        <>
          <button
            ...
            onClick={() =>
              navigate(
                `/dd-empServiceById/${cell.row.values.service_no}/${props.page}`
              )
            }
          >
            View
...
export default DDEmpServiceReqList;
