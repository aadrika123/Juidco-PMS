  ...
  return (
    <>
      <div className='bg-white rounded-md w-full shadow-md p-4'>
        ...
        <div className='mt-5'>
          <div className='p-4 mb-6 bg-white shadow-md border border-gray-200 rounded-md w-1/2'>
            <div className=''>
              <label
            ...
            <div className=''>
              {/* <label htmlfor="default-input" className="block mb-2 text-sm font-medium text-gray-900">Tender Type<span className='text-red-500'>*</span></label> */}
