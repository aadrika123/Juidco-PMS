                                            ...
                                            <div className="flex space-x-10 pl-4 my-2 border-y-gray-200">
                                                ...
                                                <div className='flex-1 text-xs'>
                                                    <div className='font-semibold text-sm text-[#37517e]'>
                                                        ...
                                                        <button className="border px-3 py-1 rounded shadow border-blue-500 hover:bg-blue-500 hover:text-white text-blue-500 whitespace-nowrap ml-2" onClick={() => navigate(`/pet-license/${applicationFullData?.registration_id}`)}>License</button>
                                                    </div>
                                                </div>
                                            </div>
                                        }
